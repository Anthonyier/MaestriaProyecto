...
{
    public partial class FormListaConciliacionCorp : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Persona.ListPagarCorp != 1)
            {
                ...
                GridViewCociliacionCorp.Visible = false;
                GridViewCociliacionCorp.Visible = false;
            }
        }

        protected void DtgListaConcCorporacionPagar_RowCommand(object sender, GridViewCommandEventArgs e)
        {
        ...
        protected void GridViewCociliacionCorp_SelectedIndexChanged(object sender, EventArgs e)
        {
