...
namespace CapaPresentacion
{
    public partial class AsignacionRuta : System.Web.UI.Page
    {
        ...
        protected void Cliente_SelectedIndexChanged(object sender, EventArgs e)
        {
            //if (Cliente.Text != "")
            //{
            //    SqlDataReader d = NegAsignacionRuta.BuscarCliente(Cliente.Text);
            //    SqlDataReader r = NegAsignacionRuta.BuscarRecepcion();
            ...
            //            try
            //            {
            //                TextCli.Text = d["CLIENTE"].ToString();
            //                IdPersona = int.Parse(d["Id_Persona"].ToString());
            //                if(IdPersona==6017)
            //                {
            //                    int id = int.Parse(r["valor"].ToString());
            //                    id = id + 1;
            //                    TextRecep.Text = id.ToString();
            //                }
            //                CargarCombo();
            //            }
            //            catch (Exception er)
