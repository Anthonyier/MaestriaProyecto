...
{
    public partial class FormListaSolPagoAceCheque : System.Web.UI.Page
    {
        ...
        protected void DtgListaSolicitudAceitePagoCheque_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Confirmar")
            {
                ...
                Response.Redirect("FormImgPagasChequesAceite.aspx?Id=" + ConciliacionId);
                }
            }
