...
{
    public partial class FormDocumentosAceite : System.Web.UI.Page
    {
        ...
        protected void DtgPagadosDocAceite_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Descargar")
            {
                string ConciliacionId = e.CommandArgument.ToString();
                Response.Redirect("FormDescargarAceite.aspx?Id=" + ConciliacionId);
            ...
            {
                string ConciliacionId = e.CommandArgument.ToString();
                Response.Redirect("FormImagenConcVisAceite.aspx?Id=" + ConciliacionId);
            }
        }
    }
}