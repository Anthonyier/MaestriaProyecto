<%@ Page Title="" Language="C#" MasterPageFile="~/FormularioPrincipal.Master" AutoEventWireup="true" CodeBehind="FormConfirmarDescarga.aspx.cs" Inherits="CapaPresentacion.FormConfirmarDescarga" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <div id="abrigo_formulario">
        <h2 style="text-align:center" >
            ...
            <span class="auto-style4">Confirmacion De Fecha Descarga</span></h2>
        <table>
            <tr>
                 <td style="text-align: right;font-size:medium; font-family:Calibri;">Fecha Descarga: </td>
                    <td>
                        ...
                        <ContentTemplate>
                            ...
                            <asp:ImageButton ID="ImageTextDesCarga" runat="server" Height="16px" ImageUrl="~/Bercam/descarga.png" 
