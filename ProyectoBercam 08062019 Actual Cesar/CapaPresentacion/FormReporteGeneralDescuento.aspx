<%@ Page Title="" Language="C#" MasterPageFile="~/FormularioPrincipal.Master" AutoEventWireup="true" CodeBehind="FormReporteGeneralDescuento.aspx.cs" Inherits="CapaPresentacion.FormReporteGeneralDescuento" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" width="100%">
        <LocalReport ReportEmbeddedResource="CapaPresentacion.ReporteDescuentoTotal.rdlc" ReportPath="ReporteDescuentoTotal.rdlc">
            <datasources>
