...
{
    public partial class FormcConfirmarPorgramacionFecha : System.Web.UI.Page
    {
        ...
        protected void BtnGuardar_Click(object sender, EventArgs e)
        {
            ...
            int modo = Convert.ToInt32(Request.QueryString["Modo"]);
            ...
            else
            {
                if(modo == 2)
                {
                    Response.Redirect("FormConfirmarViajePlaca.aspx");
                }
            }
            //EnviarCorreo();
        }
