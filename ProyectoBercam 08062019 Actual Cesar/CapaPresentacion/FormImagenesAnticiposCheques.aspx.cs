...
{
    public partial class FormImagenesAnticiposCheques : System.Web.UI.Page
    {
        ...
        protected void BtnGuardar_Click(object sender, EventArgs e)
        {
            ...
            int IdImagenAnticipio = NegImagenesAnticipos.ObtenerImagAntic(DetalleId);
            if (IdImagenAnticipio == 0)
            {
