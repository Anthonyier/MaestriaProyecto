...
{
    public partial class FormListaAdelantosCheques : System.Web.UI.Page
    {
        ...
        protected void DtgListaAdelantoCheque_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "AgregarDocumento")
            {
                ...
                if (Permiso.PagarAdelantoDePago == 1)
                {
                    ...
                    Response.Redirect("FormImagenAdelPagoCheque.aspx?Id=" + AdelantoId);
                }
