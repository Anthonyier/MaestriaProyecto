...
{
    public partial class FormReporteResumenAlcoholCliente : System.Web.UI.Page
    {
        ...
        protected void ButtonBus_Click(object sender, EventArgs e)
        {
            ...
            parameter[2] = new ReportParameter("Nombre", cmCliente.Text);
        ...
        public void CargarCliente()
        {
            ...
            try
            {
                string sql = "SELECT Nombre +' '+ Apellidos As Nombre,Id_Persona FROM Persona where Id_Persona=3402 or Id_Persona=3403 or Id_Persona=3404";
                cmd.CommandText = sql;
                cmd.Connection = cnx;
