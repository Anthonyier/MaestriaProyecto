...
{
    public partial class FormListaConcYPFBInter : System.Web.UI.Page
    {
        ...
        protected void DtgListaConcYpfbInter_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Imprimir")
            {
                string sPersonaId = e.CommandArgument.ToString();
                Response.Redirect("FormRepCobrYPFBInternacional.aspx?Id=" + sPersonaId);
            }
