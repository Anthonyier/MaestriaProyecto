...
{
    public partial class FormListaNumeroDeConciliacion : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Persona.ListCobrRef != 1)
            {
                ...
                GridViewConciliacion.Enabled  = false;
            }
        }

        protected void DtgListaNumeroConciliacion_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "NumeroDeConciliacion")
            {
                string ConciliacionId = e.CommandArgument.ToString();
                Response.Redirect("FormModNroConcRefinacion.aspx?Id=" + ConciliacionId);
            }
        }
