...
{
    public partial class ListaConcPagarAceite : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                bit.Accion = "El usuario esta intentando ver la Lista de Conciliaciones A Pagar De Aceite";
        ...
        protected void DtgListaAceitePagar_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Imprimir")
            {
                string sPersonaId = e.CommandArgument.ToString();
                Response.Redirect("FormReporteAceiteAPagar.aspx?Id=" + sPersonaId);
            }
        }
    }
}