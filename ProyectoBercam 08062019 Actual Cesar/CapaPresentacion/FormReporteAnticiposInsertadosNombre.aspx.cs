...
{
    public partial class FormReporteAnticiposInsertadosNombre : System.Web.UI.Page
    {
        ...
        protected void ButtonBus_Click(object sender, EventArgs e)
        {
            ...
            parameter[0] = new ReportParameter("IdMes", cmMes.Text);
            parameter[1] = new ReportParameter("IdAño", cmAño.Text);
            parameter[2] = new ReportParameter("IdNombre", TextTitularBuscarAnticipoInsertado.Text);
