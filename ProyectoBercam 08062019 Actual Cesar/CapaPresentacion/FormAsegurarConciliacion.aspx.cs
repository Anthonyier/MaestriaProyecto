...
{
    public partial class FormAsegurarConciliacion : System.Web.UI.Page
    {
        ...
        protected void DtgListaAsegurarConciliaicion_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Aprobar")
            {
                string sPersonaId = e.CommandArgument.ToString();
                Response.Redirect("FormConciliacionAsegurada.aspx?Id=" + sPersonaId);
            }
        }
    }
}