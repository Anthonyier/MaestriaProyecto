...
{
    public partial class FormListaAsegAceite : System.Web.UI.Page
    {
        ...
        protected void DtgListaAprobadoAceite_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Imprimir")
            {
                string sPersonaId = e.CommandArgument.ToString();
                Response.Redirect("FormReporteAceiteAPagar?Id=" + sPersonaId);
            }
        }
