...
{
    public partial class FormListaConciliacionPagarYPFBInter : System.Web.UI.Page
    {
        ...
        protected void DtgListaConciliacionYpfbInter_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Imprimir")
            {
                string sPersonaId = e.CommandArgument.ToString();
                Response.Redirect("FormRepConcYpfbPagarInter.aspx?Id=" + sPersonaId);
            }
        }
    }
}