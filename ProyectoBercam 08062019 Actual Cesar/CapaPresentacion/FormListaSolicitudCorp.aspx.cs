...
{
    public partial class FormListaSolicitudCorp : System.Web.UI.Page
    {
        ...
        protected void DtgListaSolicitudCorp_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Confirmar")
            {
                ...
                if (Permiso.ImagenesPagadas == 1)
                {
                    ...
                    Response.Redirect("FormImagenesPagadasCorporacion.aspx?Id=" + ConciliacionId);
                }
