            ...
            <asp:View ID="View3" runat="server">
                <table>
                    <tr>
                     ...
                     <tr>
                        ...
                        <td>
                         ...
                         <td>
                             <asp:CheckBox ID="CheckConfDescarga" Text="Conf. Descarga" runat="server" />
                         </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:CheckBox Id="CheckAplicacion" Text="Aplicacion" runat="server" />
                        </td>
                        <td>
                            <asp:CheckBox ID="CheckDim" Text="Dim" runat="server"/>
                        </td>
                    </tr>
                     <tr>
                       <td>
