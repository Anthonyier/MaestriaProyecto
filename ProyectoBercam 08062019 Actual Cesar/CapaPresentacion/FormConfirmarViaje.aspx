            ...
            <tr>
                <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" OnRowCommand="DtgListaConfirmarViaje_RowCommand">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Confirmar Mic">
                            <ItemTemplate>
                                <asp:LinkButton ID="LinkConfirmarMic" runat="server" CausesValidation="false" CommandArgument='<%#Bind("Id_Detalle") %>'
                                 CommandName="ConfirmarMic">Confirmar Mic</asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
