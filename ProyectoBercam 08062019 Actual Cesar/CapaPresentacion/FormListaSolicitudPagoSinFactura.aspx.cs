...
{
    public partial class FormListaSolicitudPagoSinFactura : System.Web.UI.Page
    {
        ...
        protected void DtgListaSolicitudPagoSinFactura_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {bit.Accion = "El Usuario va Colocar Pago de Conciliacion";
                ...
                if (Permiso.ImagenesPagadas == 1)
                {
                    ...
                    Response.Redirect("FormPagoSinFactura.aspx?Id=" + ConciliacionId);
                }
