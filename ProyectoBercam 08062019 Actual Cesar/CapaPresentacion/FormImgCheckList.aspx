<%@ Page Title="" Language="C#" MasterPageFile="~/FormularioPrincipal.Master" AutoEventWireup="true" CodeBehind="FormImgCheckList.aspx.cs" Inherits="CapaPresentacion.FormImgCheckList" %>
            ...
            <tr>
                ...
                <td>
                     <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                         <ContentTemplate>
                             <asp:TextBox ID="TextCheckList" runat="server" Width="70px" Font-Size="Smaller"></asp:TextBox><asp:ImageButton ID="ImageCheckList" runat="server" Height="16px" ImageUrl="~/Bercam/descarga.png" Width="22px" OnClick="ImageCheckList_Click"  />
                             <asp:Label ID="LabelCheckList" runat="server" Text ="" BackColor="Red" Font-Size="XX-Small"></asp:Label>
                             </td>
