...
{
    public partial class FormListaNroContratoAceite : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                GridViewContratoAceite.Visible = false;
                GridViewContratoAceite.Enabled = false;
            }
        }
        protected void DtgListaNumeroConci_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "NumeroDeContrato")
            {
                string ConciliacionId = e.CommandArgument.ToString();
                Response.Redirect("FormNroContratoAceite.aspx?Id=" + ConciliacionId);
            }
        }
