<%@ Page Title="" Language="C#" MasterPageFile="~/FormularioPrincipal.Master" AutoEventWireup="true" CodeBehind="FormReporteDetalleViajeAnticipoInsertado.aspx.cs" Inherits="CapaPresentacion.FormReporteDetalleViajeAnticipoInsertado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%">
        <LocalReport ReportEmbeddedResource="CapaPresentacion.ReportAnticiposInsertados.rdlc" ReportPath="ReportAnticiposInsertados.rdlc">
            <datasources>
