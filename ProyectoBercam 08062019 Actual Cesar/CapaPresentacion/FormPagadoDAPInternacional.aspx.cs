...
{
    public partial class FormPagadoDAPInternacional : System.Web.UI.Page
    {
        ...
        protected void DtgPagadosDAPInternacional_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Descargar")
            {
                string ConciliacionId = e.CommandArgument.ToString();
                Response.Redirect("FormDescargarLiquidacion.aspx?Id=" + ConciliacionId);
            ...
            {
                string ConciliacionId = e.CommandArgument.ToString();
                Response.Redirect("FormImagenConcVis.aspx?Id=" + ConciliacionId);
            }
        }
    }
}