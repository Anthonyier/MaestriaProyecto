...
namespace CapaPresentacion
{
    ...
    public class Handler1 : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            Pag.IdConciliacionAceite = Convert.ToInt32(context.Request.QueryString["Id"]);
            SqlCommand cmd = null;
            SqlDataReader dr = null;
            ClaseConexion cn = new ClaseConexion();
            SqlConnection cnx = cn.conectar();
            cmd = new SqlCommand("ProcMostrarImgLiquiAceite", cnx);
            cmd.Parameters.AddWithValue("@Id", Pag.IdConciliacionAceite); //CodigoEntidad);
