<%@ Page Title="" Language="C#" MasterPageFile="~/FormularioPrincipal.Master" AutoEventWireup="true" CodeBehind="FormHabDeshab.aspx.cs" Inherits="CapaPresentacion.FormHabDeshab" %>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:Panel ID="Panel1" runat="server">
                            <asp:TextBox ID="TxtPlacaHabDeshab" runat="server" Width="100px"></asp:TextBox>
                            <asp:Button ID="BtnPlacaHabDeshab" runat="server" Text="Buscar Placa" Width="100px" Font-Size="smaller" OnClick="BtnPlaca_Click" />
