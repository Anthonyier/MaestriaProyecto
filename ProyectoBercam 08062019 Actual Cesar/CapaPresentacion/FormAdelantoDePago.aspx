<%@ Page Title="" Language="C#" MasterPageFile="~/FormularioPrincipal.Master" AutoEventWireup="true" CodeBehind="FormAdelantoDePago.aspx.cs" Inherits="CapaPresentacion.FormAdelantoDePago" %>
    ...
    <div id="abrigo_formulario">
        <h2>
            <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
                Registro De Adelantos De Pagos
        </h2>
        <table>
            <tr>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:Panel ID="Panel1" runat="server">
                            <asp:TextBox ID="TextoClienteAdelantoDePago" runat="server" Width="300px" OnTextChanged="TextoClienteAdelantoDePago_TextChanged" ></asp:TextBox>
                        </asp:Panel>
            ...
            <tr>
                 <td style="text-align: right;font-size:medium; font-family:Calibri;">Fecha Adelanto: </td>
                    <td>
                        ...
                        <ContentTemplate>
                            <asp:TextBox ID="TextAdelanto" runat="server" Width="70px" Font-Size="Smaller" style="font-size: xx-small"></asp:TextBox>
