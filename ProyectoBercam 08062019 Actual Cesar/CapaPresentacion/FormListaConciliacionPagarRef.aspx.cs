...
{
    public partial class FormListaConciliacionPagarRef : System.Web.UI.Page
    {
        ...
        protected void DtgListaConciliacionPagar_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Imprimir")
            {
                string sPersonaId = e.CommandArgument.ToString();
