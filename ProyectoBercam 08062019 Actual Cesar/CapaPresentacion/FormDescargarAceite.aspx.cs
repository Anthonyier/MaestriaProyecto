...
{
    public partial class FormDescargarAceite : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ObjImagen = NegImgPagadas.ConsultaImagenAceite(ImagenId);
                if (ObjImagen != null)
                {
        ...
        protected void BtnPagado_Click(object sender, EventArgs e)
        {
            ...
            EntImagenesPagadas DocImg = new EntImagenesPagadas();
            Img = NegImgPagadas.DownloadAceite(Convert.ToInt32(Request.QueryString["Id"]));
            if (Img == null)
            {
