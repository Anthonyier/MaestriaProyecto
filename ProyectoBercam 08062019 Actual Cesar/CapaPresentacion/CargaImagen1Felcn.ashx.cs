...
namespace CapaPresentacion
{
    ...
    /// </summary>
    public class CargaImagen1Felcn : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            int NC = Convert.ToInt32(context.Request.QueryString["Felcn"]);
            DAOPersona Per = new DAOPersona();
            int num = Per.valor(NC, 3);
            ...
            //cmd.Parameters.AddWithValue("@Tipo_Imagen", 3);
