...
{
    public partial class FormListImgAdelanto : System.Web.UI.Page
    {
        ...
        protected void DtgListaImgAdelanto_RowCommand(object sender, GridViewCommandEventArgs e)
        {

            if (e.CommandName == "Visualizar")
            {
                string AnticipoId = e.CommandArgument.ToString();
                Response.Redirect("FormAdelantoDePagoImagenes.aspx?Id=" + AnticipoId);
            }
        }
    }
}