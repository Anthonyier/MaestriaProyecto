...
{
    public partial class FormListaAnticiposCheques : System.Web.UI.Page
    {
        ...
        protected void DtgListaAnticipoCheque_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "AgregarDocumento")
            {
                ...
                if (Anticipi.PagarAnticipo == 1)
                {
                    ...
                    Response.Redirect("FormImagenesAnticiposCheques.aspx?Id=" + AnticipoId);
                }
