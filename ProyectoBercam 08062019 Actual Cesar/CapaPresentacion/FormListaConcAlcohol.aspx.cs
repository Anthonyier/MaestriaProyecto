...
{
    public partial class FormListaConcAlcohol : System.Web.UI.Page
    {
        ...
        protected void DtgListaConcAlcoholRowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Imprimir")
            {
                string sPersonaId = e.CommandArgument.ToString();
                Response.Redirect("FormRepConCorpAlcohol.aspx?Id=" + sPersonaId);
            }
