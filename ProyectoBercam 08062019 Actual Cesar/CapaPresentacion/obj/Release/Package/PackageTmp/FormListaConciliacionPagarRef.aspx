<%@ Page Title="" Language="C#" MasterPageFile="~/FormularioPrincipal.Master" AutoEventWireup="true" CodeBehind="FormListaConciliacionPagarRef.aspx.cs" Inherits="CapaPresentacion.FormListaConciliacionPagarRef" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div id="abrigo_formulario">
        ...
        <table>
         ...
         <table>
             <tr>
                 <asp:GridView ID="GridViewConciliacion" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AllowPaging="true"  pagesize="20" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="SqlDataSource1" OnRowCommand="DtgListaConciliacionPagar_RowCommand" >
