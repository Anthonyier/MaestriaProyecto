<%@ Page Title="" Language="C#" MasterPageFile="~/FormularioPrincipal.Master" AutoEventWireup="true" CodeBehind="FormListaViajesNoDespachados.aspx.cs" Inherits="CapaPresentacion.FormListaViajesNoDespachados" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="abrigo_formulario">
        <h2> Lista De Viajes No Confirmados </h2>
        <table>
            <tr>
        ...
        <table>
            <tr>
                <asp:GridView ID="GridView1" runat="server" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2" ForeColor="Black" GridLines="None" AutoGenerateColumns="False" DataSourceID="SQLDataSource1" >
        ...
        <asp:SqlDataSource ID="SQLDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:bercamConnectionString %>" SelectCommand="ProcViajesNoDespachados" SelectCommandType="StoredProcedure" >
            <SelectParameters>
