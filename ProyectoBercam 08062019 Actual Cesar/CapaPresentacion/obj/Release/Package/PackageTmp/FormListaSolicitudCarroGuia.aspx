<%@ Page Title="" Language="C#" MasterPageFile="~/FormularioPrincipal.Master" AutoEventWireup="true" CodeBehind="FormListaSolicitudCarroGuia.aspx.cs" Inherits="CapaPresentacion.FormListaSolicitudCarroGuia" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="abrigo_Formulario">
         <h2>Lista de Solictudes De Conciliacion Carro Guia</h2>
        <table>
            <tr>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:bercamConnectionString %>" SelectCommand="BuscarListaSolicitudCarroGuia" SelectCommandType="StoredProcedure"  >
            <SelectParameters>
