<%@ Page Title="" Language="C#" MasterPageFile="~/FormularioPrincipal.Master" AutoEventWireup="true" CodeBehind="FormReporteLiquidacionPagadaSuma.aspx.cs" Inherits="CapaPresentacion.FormReporteLiquidacionPagadaAceite" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%">
       <LocalReport ReportEmbeddedResource="CapaPresentacion.ReportSumaLiquidaciones.rdlc" ReportPath="ReportSumaLiquidaciones.rdlc"> 
             <datasources>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="CapaPresentacion.DataSetLiquidacionPagadaTableAdapters.SumaLiquidacionPagadaTableAdapter"></asp:ObjectDataSource>
    <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="CapaPresentacion.DataSetLiquidacionPagadaTableAdapters.SumaLiquidacionPagadaAceiteTableAdapter"></asp:ObjectDataSource>
