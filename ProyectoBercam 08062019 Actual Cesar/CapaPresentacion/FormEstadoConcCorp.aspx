<%@ Page Title="" Language="C#" MasterPageFile="~/FormularioPrincipal.Master" AutoEventWireup="true" CodeBehind="FormEstadoConcCorp.aspx.cs" Inherits="CapaPresentacion.FormEstadoConcCorp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="abrigo_Forimulario">
        <h2> Estado De Conciliaciones De Corporacion</h2>
        <table>
            <tr>
        ...
        <table>
            <tr>
                <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Horizontal" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="SqlDataSource1" >
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="IdMes" SortExpression="IdMes" Visible="False">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="Label5" runat="server" Text='<%# Bind("IdMes") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:bercamConnectionString %>" SelectCommand="BuscarConCorpEstado" SelectCommandType="StoredProcedure" >
            <SelectParameters>
